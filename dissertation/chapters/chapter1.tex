...
\newthought{Matter around compact astrophysical objects} is typically fully ionized as their characteristic temperatures far exceed the atomic binding energies. As a result, the dynamics of such matter is vitally governed by the interplay between the charged particles and the electromagnetic field.
...
\DRAFT{Move everything at the top of this to introduction. Then carry on with some astrophysical motivations (pulsars, magnetars, blazars, coronae, MAD disks etc).}
...
\DRAFT{Motivate why we need GCA here. Then explain why just simple GCA will not work. Then explain what the coupled Boris/GCA is, and how it works. Explain why this will help a lot in simulations of the magnetosphere, both from the point of view of scale separation, and radiation.}
