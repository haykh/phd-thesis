...
\begin{figure}[ht]
    \centering
    \centerline{\includegraphics[width=\textwidth]{figures/ch4-pairproduction/fig2.pdf}}
...
\end{equation}
For the Crab, with $B_{\rm LC}\sim 4\times 10^6$ G, these values are $\gamma_{\rm rad}\approx 10^4$ and $\gamma_c\approx 3\times 10^3$~\citep{2014ApJ...780....3U}, and the typical magnetization near the light cylinder is $10^4\text{-}10^5$. We, thus, have a hierarchy of energy scales with $\gamma_c < \gamma_{\rm rad} \lesssim \sigma_{\rm c}$, which we will use in our simulations.
...
% \sasha{again, too many words. may be add an equation that clarifies?} \hayk{I just don't want to write the same equation 2 times}%, defining the position of the synchrotron peak.
    ...
    \end{equation}
    where $\sigma_{\gamma\gamma}$ is the Breit-Wheeler cross section that depends on momenta and energies of the two photons, and $\sigma_{\rm T}$ is the Thomson cross section. We choose a particular value of $p_0$ to ensure that the optical thickness of the overall system is small, while still producing enough secondary plasma. In Appendix~\ref{sec:pairprod-appendixA} we discuss in more detail how varying this parameter affects the regime we are simulating. 
\end{itemize}
...
\begin{figure}[tb]
    \centering
    \centerline{\includegraphics[width=\textwidth]{figures/ch4-pairproduction/fig5.pdf}}
...
\begin{figure}[tb]
    \centering
    \centerline{\includegraphics[width=0.85\textwidth]{figures/ch4-pairproduction/fig6.pdf}}
...
\begin{figure}[htb]
    \centering
    \centerline{\includegraphics[width=\textwidth]{figures/ch4-pairproduction/fig7.pdf}}
...
\begin{figure}[H]
    \centering\includegraphics[width=0.9\textwidth]{figures/ch4-pairproduction/fig8.pdf}
...
\begin{figure}[htb]
    \centering
    \centerline{\includegraphics[width=\textwidth]{figures/ch4-pairproduction/fig9.pdf}}
...
\begin{figure}[htb]
    \centering
    \centerline{\includegraphics[width=\textwidth]{figures/ch4-pairproduction/fig10.pdf}}
...
\begin{figure}[htb]
    \centering
    \centerline{\includegraphics[width=\textwidth]{figures/ch4-pairproduction/fig11.pdf}}
